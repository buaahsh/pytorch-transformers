...
class ContextModel:
    ...
    def concat(self, input_ids, token_type_ids=None, attention_mask=None, labels=None,
        ...
        context_outputs = self.context_model.roberta(flat_input_ids, position_ids=position_ids,
                                                     token_type_ids=token_type_ids,
                                                     attention_mask=flat_attention_mask, head_mask=head_mask)

        outputs = self.model.roberta(flat_input_ids, position_ids=position_ids, token_type_ids=token_type_ids,
                               attention_mask=flat_attention_mask, head_mask=head_mask, context_inputs=context_outputs[0])
